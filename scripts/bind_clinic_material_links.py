...
items = [
    ...
    ('primeiros-clientes', '15-FUwki44zVJJXtMth1ryFeegnLKoci5'),
    ('checklist-seguranca', '1CEKbgpp1X1rBWUHpo1DK7NZIeWuwhCJ9'),
...
for material_id, file_id in items:
    ...
    cover = '/clinic-materials/guia-hidraulica-cover.webp' if material_id == 'guia-hidraulico' else base + '/thumbnail?id=' + file_id + '&sz=w1200'
